        ...
        <div className="h-screen flex items-center justify-center bg-slate-100">
            <div className="max-w-xs w-full space-y-8">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="!mt-1">
                        <Link className="font-medium text-indigo-800 hover:text-indigo-500" to={"/forgot-password"}>Forgot Password?</Link>
                    </div>
                    <div className="!mt-4">
                       
                        <Link className="font-medium text-indigo-800 hover:text-indigo-500" to={"/signup"}>Sign Up</Link>
                    </div>
                </form>
            </div>
        </div>
